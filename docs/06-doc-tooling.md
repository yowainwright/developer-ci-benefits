...
- **README:** the README is, in general, a markdown file that provides information about a repository
- **CHANGELOG:** the CHANGELOG is a markdown file that describes changes within a repository
...
- **LICENSE:** the LICENSE is a text file that dictates rules of law to protect a repository
...
- **CONTRIBUTING:** the CONTRIBUTING template is an auto-reply markdown template that provides repository contributing context by referencing CODE OF CONTENT and may be guidelines for successful contribution
