...
- **[Talk Objectives](docs/01-talk-objectives.md)**
  - Talk introduction
- **[Key Points](docs/02-key-points.md)**
  - The key points covered in the talk
- **[Supporting Quotes](docs/03-supporting-quotes.md)**
  - Quotes to sell this talks value
- **[What is CI](docs/04-what-is-ci.md)**
  - CI definition with context
- **[Doc Tooling](docs/05-doc-tooling.md)**
  - A description and list of repository documentation
- **[Unit Testing](docs/06-unit-testing.md)**
  - Introduction to unit testing
  - A basic unit testing example in pure JavaScript
- **[Acceptance Testing](docs/07-acceptance-testing.md)**
  - Introduction to end to end testing
  - A basic end-to-end test example
- **[Safety Checks](docs/08-safety-checks.md)**
  - A list of tools to assist with CI
- **[Running Tests and Checks](docs/09-running-tests-and-checks.md)**
  - How to run tests and checks
- **[Implementing CI](docs/10-implementing-ci.md)**
  - The basics of implementing CI
- **[Dependency Updates](docs/11-dependency-updates.md)**
  - A description of what dependencies are and how to update them
- **[Publishing Repositories](docs/12-publishing-repositories.md)**
  - A high level walk through of publishing NPM packages
- **[Benefits of CI](docs/13-ci-benefits.md)**
  - CI benefits
- **[Optimizations](docs/14-optimizations.md)**
